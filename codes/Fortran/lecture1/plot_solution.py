...
plt.axis('equal')             # so x- and y-axis scaled the same (square)
pp=plt.pcolor(X,Y,U)  # pseudo-color plot using colormap "jet"
#plt.clim(0., 1.)               # colors range from u=0 to u=1
plt.colorbar(pp)                 # add a color bar to show temperature scale
